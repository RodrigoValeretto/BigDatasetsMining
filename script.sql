...
/*
	...
	Alunos:
	André Bermudes Viana			NUSP: 10684580
...
-- Conta quantos homens e mulheres nasceram em cada decada (O valor NULL corresponde à pessoas que nao tem dados)
...
join pacientes p on p.id_paciente = e.id_paciente 
where de_analito = 'Coronavírus (2019-nCoV)'
